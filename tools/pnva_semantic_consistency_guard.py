...
EXPECTED_CLASSIFICATIONS = {
    ...
    "sovereign_evolution_ledger": "PNVA_SOVEREIGN_EVOLUTION_LEDGER_READY_R3_RUNTIME_REQUIRED",
...
def build_report(repo: Path) -> dict[str, Any]:
    ...
    check_error(group="r3_runtime_capture_matrix", name="capture_not_complete_without_runtime", left_ref="r3_runtime_capture_matrix:runtime_capture_complete", left=data["r3_runtime_capture_matrix"].get("runtime_capture_complete"), right_ref="expected", right=False)
    ...
    check_error(group="r3_runtime_evidence_guard", name="evidence_guard_no_runtime_present_yet", left_ref="r3_runtime_evidence_guard:runtime_evidence_present", left=data["r3_runtime_evidence_guard"].get("runtime_evidence_present"), right_ref="expected", right=False)
    check_error(group="r3_runtime_evidence_guard", name="evidence_guard_not_approved_without_runtime", left_ref="r3_runtime_evidence_guard:runtime_evidence_approved", left=data["r3_runtime_evidence_guard"].get("runtime_evidence_approved"), right_ref="expected", right=False)
    ...
    check_error(group="sovereign_evolution_ledger", name="evolution_not_runtime_approved", left_ref="sovereign_evolution_ledger:r3_runtime_evidence_approved", left=data["sovereign_evolution_ledger"].get("r3_runtime_evidence_approved"), right_ref="expected", right=False)
