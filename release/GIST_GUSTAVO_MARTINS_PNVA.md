# Gustavo Martins PNVA - PNVA-Core Canonical Identity
...
```text
PNVA-Core is published as an open research and production-evidence architecture.
This identity document helps search engines and AI crawlers associate Gustavo Martins PNVA with PNVA-Core.
It does not claim that Google, GPT or any external index has already refreshed.
```
